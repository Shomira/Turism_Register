...
class AddLugarMainFragment : Fragment(), AdapterView.OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // ===============FIN subir imagen
        (activity as AppCompatActivity).bottom_navegation_view.menu.findItem(R.id.fragmentToReturn).isVisible =
            false
        ...
        btn_siguiente_add_lugar.setOnClickListener {
            if (ip_nombre_atr.text.toString().isEmpty() || ip_descripcion_atr.text.toString()
                    .isEmpty() ||
                ip_provincia.text.toString().isEmpty() || ip_canton.text.toString()
                    .isEmpty() || ip_parroquias.text.toString().isEmpty()
            ) {
                Toast.makeText(
                    context,
                    "Los campos de nombre, descripción, provincia, canton, parroquia, son obligatorios",
                    Toast.LENGTH_LONG
                ).show()
                contadorPantallas = 0
            } else {
        ...
        btn_guardarLugarMain.setOnClickListener {
            if (ip_nombre_atr.text.toString().isEmpty() || ip_descripcion_atr.text.toString()
                ...
                val dialogView: View = LayoutInflater.from(contextF)
                    .inflate(R.layout.editanto_agregando_dialog_lugar, null)
                dialog.window?.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))

                val popTitleDialog: TextView =
                    dialogView.findViewById(R.id.tv_title_guardando_editando_lugar_dialog)
                val card_view_dialog: CardView =
                    dialogView.findViewById(R.id.card_view_dialog_modificar_agregar_lugar)
                if (is_editar == "false") {
                    popTitleDialog.setText("AGREGANDO")
                    card_view_dialog.setCardBackgroundColor(
    ...
    fun cargandoDatosFirebase() {
        ...
        database.collection("lugares").document(id).set(
            hashMapOf(
                "id" to id,
    ...
    fun isEditarLlenandoCampos() {
        (activity as AppCompatActivity).bottom_navegation_view.menu.findItem(R.id.fragmentToReturn).isVisible =
            true
        var adapterProv = activity?.let {
            ArrayAdapter<String>(
                it, R.layout.item_select,
        ...
        database.collection("lugares").document(id).get().addOnSuccessListener {
            ...
            with(ip_frecuencia_transporte_p3) {
                setAdapter(adapterFrecuenciaTransporte)
                onItemClickListener = this@AddLugarMainFragment
            }
            ...
            with(ip_senializacion_estado_p3) {
                setAdapter(adapterSenializacion)
                onItemClickListener = this@AddLugarMainFragment
            }
...
*/
    ...
    fun selectParroquiasRestantes(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
        ...
        if (item == "San Lorenzo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_san_lorenzo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Atacames") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_atacames)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Rioverde") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_rioverde)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "La Concordia") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_concordia)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Guayaquil") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_guayaquil)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Alfredo Baquerizo Moreno(Juján)") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_baquerizo_moreno)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_balao)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_balzar)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Colimes") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_colimes)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_daule)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_duran)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "El Empalme") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_empalme)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "El Triunfo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_triunfo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Milagro") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_milagro)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Naranjal") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_naranjal)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Naranjito") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_naranjito)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Palestina") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_palestina)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Pedro Carbo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pedro_carbo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Samborondón") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_samborondon)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Santa Lucía") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_santa_lucia)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Salitre") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_salitre)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "San Jacinto de yaguachi") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_jacinto_yaguachi)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_playas)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Simón Bolívar") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_simon_bolivar)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Coronel Marcelino Maridueña") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_marcelino_mariduenia)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Lomas de Sargentillo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_lomas_sargentillo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_nobol)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "General Antonio Elizalde") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_antonio_elizalde)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Isidro Ayora") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_isidro_ayora)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_ibarra)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Antonio Ante") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_antonio_ante)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Cotacachi") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_cotacachi)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Pimampiro") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pimampiro)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "San Miguel de Urcuquí") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_miguel_urcuqui)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_loja)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_calvas)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Catamayo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_catamayo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_celica)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Chaguarpamba") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_chaguarpamba)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Espíndola") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_espindola)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Gonzanamá") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_gonzanama)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_macara)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_paltas)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Puyango") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_puyango)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Saraguro") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_saraguro)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Sozoranga") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_sozoranga)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Zapotillo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_zapotillo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pindal)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Quilanga") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_quilanga)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_olmedo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Babahoyo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_babahoyo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_baba)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Montalvo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_montalvo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Puebloviejo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_puebloviejo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Quevedo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_quevedo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Urdaneta") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_urdaneta)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Ventanas") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_ventanas)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_vinces)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Palenque") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_palenque)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Buena Fé") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_buena_fe)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Valencia") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_valencia)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Mocache") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_mocache)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Quinsaloma") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_quinsaloma)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Portoviejo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_portoviejo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_bolivar_manabi)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_chone)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "El Carmen") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_carmen)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Flavio Alfaro") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_flavio_alfaro)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Jipijapa") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_jipijapa)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_junin)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_manta)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Montecristi") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_montecristi)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pajan)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pichincha)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Rocafuerte") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_rocafuerte)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Santa Ana") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_santa_ana)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_sucre)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Tosagua") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_tosahua)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "24 de mayo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_24_mayo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Pedernales") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pedernales)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Puerto López") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_puerto_lopez)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_jama)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Jaramijo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_jaramijo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "San Vicente") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_san_vicente)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_morona)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Gualaquiza") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_gualaquiza)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Limón Indanza") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_limon)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_palora)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_morona_santiago)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_morona_sucua)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Huamboya") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_morona_huamboya)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "San Juan Bosco") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_juan_bosco)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_morona_taisha)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Logroño") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_logronio)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Pablo Sexto") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pablo_sexto)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Tiwinza") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_tiwintza)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_tena)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Archidona") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_archidona)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "El Chaco") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_chaco)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_quijos)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Carlos Julio Arosemena Tola") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_carlos_julio)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pastaza)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_mera)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Santa Clara") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_santa_clara)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Arajuno") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_arajuno)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_quito)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Cayambe") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_cayambe)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_mejia)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Pedro Moncayo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_moncayo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Rumiñahui") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_ruminiahui)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "San Miguel de los Bancos") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_miguel_bancos)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Pedro Vicente Maldonado") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_vicente_maldonado)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Puerto Quito") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_puerto_quito)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_ambato)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Baños de Agua Santa") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_banios_agua)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Cevallos") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_cevallos)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_mocha)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_patate)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_quero)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "San Pedro de Pelileo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pedro_pelileo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "San Pedro de Píllaro") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_santiago_pillaro)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Tisaleo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_tisaleo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_zamora)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Chinchipe") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_chinchipe)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Nangaritza") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_nangaritza)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Yacuambi") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_yacuambi)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Yantzaza") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_yantzaza)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "El Pangui") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pangui)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Centinela del Condor") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_centinela_condor)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Palanda") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_palanda)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Paquisha") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_paquisha)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "San Cristóbal") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_san_cristobal)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Isabela") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_isabela)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Santa Cruz") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_santa_cruz)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Lago Agrio") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_lago_agrio)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Gonzalo Pizarro") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pizarro)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Putumayo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_putumayo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Shushufindi") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_shushufindi)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Sucumbíos") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_sucumbios)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Cascales") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_cascales)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Cuyabeno") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_cuyabeno)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_orellana)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Aguarico") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_aguarico)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "La Joya de los Sachas") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_joya_sachas)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_loreto)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Santo Domingo") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_santo_domingo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_santa_elena)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "La Libertad") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_libertad)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
        ...
        } else if (item == "Salinas") {
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_salinas)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
    ...
    fun selectProvinciasCantones(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
        ...
        val item = parent?.getItemAtPosition(position).toString()
        selectParroquiasRestantes(parent, view,position,id)
        ...
        if (item == "Atractivos Naturales") {
            ...
            val adapter =
                activity?.let { ArrayAdapter<String>(it, R.layout.item_select, arquitectura) }
            with(ip_subtipo) {
                setAdapter(adapter)
                onItemClickListener = this@AddLugarMainFragment
            }
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.sbtp_ambienteslacustres)
                )
            }
            with(ip_subtipo) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.sbtp_rios)
                )
            }
            with(ip_subtipo) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.sbtp_bosques)
                )
            }
            with(ip_subtipo) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.sbtp_aguassubterraneas)
                )
            }
            with(ip_subtipo) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.sbtp_fenomenos_es)
                )
            }
            with(ip_subtipo) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.sbtp_fenomenos_ge)
                )
            }
            with(ip_subtipo) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.sbtp_costaslitorales)
                )
            }
            with(ip_subtipo) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.sbtp_ambientesmarinos)
                )
            }
            with(ip_subtipo) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.sbtp_tierrasinsulares)
                )
            }
            with(ip_subtipo) {
                setAdapter(adapter)
        ...
        //============================================PROVINCIAS Y CANTONES ============================================
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_azuay)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_bolivar)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_caniar)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_carchi)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_cotopaxi)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_chimborazo)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_oro)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_esmeraldas)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_guayas)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_imbabura)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_loja)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_rios)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_manabi)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_morona)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_napo)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_pastaza)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_pichincha)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_tungurahua)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_zamora)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_galapagos)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_sucumbios)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_orellana)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_santodomingo)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.cantones_santaelena)
                )
            }
            with(ip_canton) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_cuenca)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_giron)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_gualaceo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_nabon)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_paute)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pucara)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_sanfernando)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_santaisabel)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_sigsig)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_ona)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_chordeleg)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_elpan)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_sevilladeoro)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_guachapala)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_camiloponce)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_guaranda)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_chillanes)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_chimbo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_echendia)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_sanmiguel)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_caluma)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_lasnaves)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_azogues)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_biblian)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_caniar)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_latroncal)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_tambo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_deleg)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_suscal)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_tulcan)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_bolivar)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_espejo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_mira)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_montufar)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_sanpedro)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_latacunga)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_lamana)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pangua)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pujili)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_salcedo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_saquisili)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_sigchos)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_riobamba)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_alausi)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_colta)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_chambo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_chunchi)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_guamote)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_guano)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pallatanga)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_penipe)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_cumanda)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_machala)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_arenillas)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_atahualpa)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_balsas)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_chilla)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_elguabo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_huaquillas)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_marcabeli)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pasaje)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_pinias)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_portovelo)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_santarosa)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_zaruma)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_laslajas)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_esmeraldas)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_eloyalfaro)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_muisne)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.parroquias_quininde)
                )
            }
            with(ip_parroquias) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.tipo_observacion)
                )
            }
            with(ip_tipo_facilidad_entorno) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.tipo_servicio)
                )
            }
            with(ip_tipo_facilidad_entorno) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.tipo_ambiente_areas_naturales)
                )
            }
            with(ip_higiene_senialetica_tipo) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.letreros)
                )
            }
            with(ip_higiene_senialetica_tipo) {
                setAdapter(adapter)
            ...
            val adapter = activity?.let {
                ArrayAdapter<String>(
                    it,
                    R.layout.item_select,
                    resources.getStringArray(R.array.senialetica_interna)
                )
            }
            with(ip_higiene_senialetica_tipo) {
                setAdapter(adapter)
